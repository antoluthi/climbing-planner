...
export function MicroColorDot({ color, inherited, c, onChange, onReset, size = 10 }) {
  const { anchorRef, open, rect, toggle, close } = usePopover();
  ...
  return (
    <>
      ...
      {open && (
        <Popover anchorRef={anchorRef} rect={rect} onClose={close}
                 width={260} label="Couleur du microcycle">
  ...
  return (
    <label style={{ display: "flex", flexDirection: "column", gap: 3 }}>
      ...
      <input
        ...
        // ⚠ Pas d'`accentColor` ici, malgré la poignée que le navigateur laisse
        // à sa couleur par défaut : elle teinte aussi la **partie remplie** de
        // la barre et efface donc le dégradé — or c'est lui qui dit ce que le
        // curseur va faire. Le repère vaut mieux que la teinte de la poignée.
